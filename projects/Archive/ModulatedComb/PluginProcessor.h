...
namespace Param
{
    ...
    namespace Ranges
    {
        ...
        static constexpr float FBMin { 0.f };
        static constexpr float FBMax { 1.f };
        static constexpr float FBInc { 0.01f };
        static constexpr float FBSkw { 0.5f };

        static constexpr float WetMin { 0.f };
        static constexpr float WetMax { 1.f };
        static constexpr float WetInc { 0.01f };
        static constexpr float WetSkw { 0.5f };
    ...
    namespace Units
    {
        ...
        static const juce::String Lin { "Lin" };

    }
}

class CombAudioProcessor : public juce::AudioProcessor
{
public:
    CombAudioProcessor();
    ~CombAudioProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CombAudioProcessor)
};